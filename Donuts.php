    ...
    <div class="recipes-box">
            ...
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2022/08/Chocolate-Donuts-Feature.jpg" alt="Chocolate Donut">
                    </a>
                </div>
            <div class="name-bakery">
                <a href="Recipe_post.php" class="name-link">
                    <span class="name">Chocolate Donut</span>
                </a>
        ...
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2018/12/Krispy-Kreme-Tree-Feature-1.jpg" alt="Christmas Donut Tree">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Christmas Donut Tree</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2016/08/rainbow-donut-feature2.jpg" alt="Rainbow Donuts">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Rainbow Donuts</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
    ...
    <div class="recipes-box">
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2018/01/redvelvet-feature-e1545941779676.jpg" alt="Red Velvet Donuts">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Red Velvet Donuts</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
