    ...
    <div class="recipes-box">
            ...
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2020/04/French-Macarons-feature-1200.jpg" alt="French Macaron">
                    </a>
                </div>
            <div class="name-bakery">
                <a href="Recipe_post.php" class="name-link">
                    <span class="name">French Macaron</span>
                </a>
        ...
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2023/12/Chocolate-Covered-Oreos-Feature.jpg" alt="Chocolate Covered Oreos">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Chocolate Covered Oreos</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2023/11/Red-Velvet-Cookies-Feature.jpg" alt="Red Velvet Cookies">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Red Velvet Cookies</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
    ...
    <div class="recipes-box">
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2023/09/Brownie-Cookies-R-Feature.jpg" alt="Brownie Cookies">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Brownie Cookies</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2023/09/Chocolate-Crinkle-Cookies-Feature.jpg" alt="Chocolate Crinkle Cookies">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Chocolate Crinkle Cookies</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2019/12/Oreo-balls-feature-1.jpg" alt="Oreo Balls">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Oreo Balls</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
