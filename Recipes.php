...
<body>
    ...
    <div class="recipes-button">
            <a href="recipebycategory.php">Breads</a>
        </div>
        <div class="recipes-button">
            <a href="recipebycategory.php">Cakes</a>
        </div>
        <div class="recipes-button">
            <a href="recipebycategory.php">Cookies</a>
        </div>
        <div class="recipes-button">
            <a href="recipebycategory.php">Cupcakes</a>
        </div>
        <div class="recipes-button">
            <a href="recipebycategory.php">Doughnuts</a>
        </div>
        <div class="recipes-button">
            <a href="recipebycategory.php">Gluten-free</a>
        </div>
    </div>
    <div class="recipes-container">
        ...
        <div class="recipes-box">
            ...
            AND category.categoryName = 'Breads' ";
    ...
    <div class="recipes-container">
        ...
        <div class="recipes-box">
            ...
            AND bakeryrecipe.BakeryId = havecategorytag.BakeyId 
            AND havecategorytag.CategoryId = category.CategoryId
            AND category.categoryName = 'Cakes' ";
            $result = $conn->query($sql);
            $i = 1;
            while($data = $result->fetch_assoc()){
                $BakeryName = $data['BakeryName'];
    ...
    <div class="recipes-container">
        ...
        <div class="recipes-box">
            ...
            AND bakeryrecipe.BakeryId = havecategorytag.BakeyId 
            AND havecategorytag.CategoryId = category.CategoryId
            AND category.categoryName = 'Cookies' ";
            $result = $conn->query($sql);
            $i = 1;
            while($data = $result->fetch_assoc()){
                $BakeryName = $data['BakeryName'];
    ...
    <div class="recipes-container">
        ...
        <div class="recipes-box">
            ...
            AND bakeryrecipe.BakeryId = havecategorytag.BakeyId 
            AND havecategorytag.CategoryId = category.CategoryId
            AND category.categoryName = 'Cupcakes' ";
            $result = $conn->query($sql);
            $i = 1;
            while($data = $result->fetch_assoc()){
                $BakeryName = $data['BakeryName'];
    ...
    <div class="recipes-container">
        <div class="title" id="Doughnuts">
            <h2>Doughnuts</h2>
        </div>
        <div class="recipes-box">
            <section>
                <div class="swiper mySwiper-5 container">
                    <div class="swiper-wrapper content">
                    <?php
            include_once("DatabaseConnect.php");
            $sql = "SELECT * FROM user, bakeryrecipe, havecategorytag, category WHERE user.UserId = bakeryrecipe.UserId
            AND bakeryrecipe.BakeryId = havecategorytag.BakeyId 
            AND havecategorytag.CategoryId = category.CategoryId
            AND category.categoryName = 'Doughnuts' ";
            $result = $conn->query($sql);
            $i = 1;
            while($data = $result->fetch_assoc()){
                $BakeryName = $data['BakeryName'];
    ...
    <div class="recipes-container">
        <div class="title" id="Gluten-free">
            <h2>Gluten-free</h2>
        </div>
        <div class="recipes-box">
            <section>
                <div class="swiper mySwiper-6 container">
                    <div class="swiper-wrapper content">
                    <?php
            include_once("DatabaseConnect.php");
            $sql = "SELECT * FROM user, bakeryrecipe, havecategorytag, category WHERE user.UserId = bakeryrecipe.UserId
