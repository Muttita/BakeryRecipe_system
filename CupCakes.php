    ...
    <div class="recipes-box">
            ...
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2020/12/christmas-ornament-cupcakes-feature-1.jpg" alt="Christmas Ornament Cupcakes">
                    </a>
                </div>
            <div class="name-bakery">
                <a href="Recipe_post.php" class="name-link">
                    <span class="name">Christmas Ornament Cupcakes</span>
                </a>
        ...
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2022/07/Strawberry-Cupcakes-Feature.jpg" alt="Strawberry Cupcakes">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Strawberry Cupcakes</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
            ...
            <div class="card-content">
                <div class="image">
                    <a href="" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2023/10/Red-Velvet-Cupcakes-Feature.jpg" alt="Red Velvet Cupcakes">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="" class="name-link">
                        <span class="name">Red Velvet Cupcakes</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
    ...
    <div class="recipes-box">
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2023/11/Gingerbread-Cupcakes-Feature.jpg" alt="Gingerbread Cupcakes">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Gingerbread Cupcakes</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
