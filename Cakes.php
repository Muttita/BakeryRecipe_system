            ...
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2022/07/Red-Velvet-Feature-1a.jpg" alt="Red Velvet">
                    </a>
                </div>
            <div class="name-bakery">
                <a href="Recipe_post.php" class="name-link">
                    <span class="name">Red Velvet</span>
                </a>
                <span class="baker">By Tommy</span>
            </div>
        </div>
        </div>
        <div class="card">
            <div class="card-content">
                ...
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Chocolate Lava</span>
                    </a>
                    <span class="baker">By Jimmy</span>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-content">
                ...
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Strawberry Cake</span>
                    </a>
    ...
    <div class="recipes-box">
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2023/11/Eggnog-Cake-Feature.jpg" alt="Eggnog Cake">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Eggnog Cake</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2023/08/Eclair-Cake-Feature.jpg" alt="Éclair Cake">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Éclair Cake</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-content">
                <div class="image">
                    <a href="Recipe_post.php" class="image-link">
                        <img src="https://preppykitchen.com/wp-content/uploads/2024/02/Hot-Milk-Cake-Feature.jpg" alt="Hot Milk Cake">
                    </a>
                </div>
                <div class="name-bakery">
                    <a href="Recipe_post.php" class="name-link">
                        <span class="name">Hot Milk Cake</span>
                    </a>
                    <span class="baker">By John</span>
                </div>
            </div>
